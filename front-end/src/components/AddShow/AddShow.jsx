...
import upload from "../../assets/drawkit-developer-woman-colour.svg";
  ...
  render() {
    return (
      <div className="add-show-form-page">
        <img id="upload" src={upload} alt="uupload" />
        <div id='add-show-page-container'>
          <div id="banner">
            ...
            <button
              ...
              id="toggle-search"
            >
              {this.state.search ? <span>Upload</span> : <span>Search</span>}{" "}
              Show
            </button>
          </div>
          {this.state.search ? (
